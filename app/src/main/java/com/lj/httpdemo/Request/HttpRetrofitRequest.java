...
import com.lj.httpdemo.Response.RxJavaObserver;
import com.lj.httpdemo.Retrofit.ApiService;
import com.lj.httpdemo.Retry.RetryFunction;
...
public class HttpRetrofitRequest extends HttpRetrofit implements IHttpRequest {
    ...
    private volatile static HttpRetrofitRequest INSTANCE;
    ...
    public static HttpRetrofitRequest getInstances() {
        if (INSTANCE == null) {
            synchronized (HttpRetrofitRequest.class) {
                if (INSTANCE == null) {
                    INSTANCE = new HttpRetrofitRequest();
                }
            }
        }
        return INSTANCE;
